...
const EmployeeTasklog = ({ user }) => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const logRes = await fetch(
        `https://cws-backend-roan.vercel.app/api/tasklogs/employee/${user._id}`,
        {
          headers: {
      ...
      const taskRes = await fetch(
        `https://cws-backend-roan.vercel.app/tasks/assigned/${user._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleDelete = async (logId, e) => {
    ...
    try {
      const response = await fetch(`https://cws-backend-roan.vercel.app/api/tasklogs/${logId}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`,
  ...
  async function handleSave(e) {
    ...
    try {
      ...
      const endpoint = editIndex !== null
        ? `https://cws-backend-roan.vercel.app/api/tasklogs/${editIndex}`
        : "https://cws-backend-roan.vercel.app/api/tasklogs/";
