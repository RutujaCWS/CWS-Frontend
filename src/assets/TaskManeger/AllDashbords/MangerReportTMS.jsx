...
function ManagerReportTMS({ user }) {
  ...
  useEffect(() => {
    ...
    const fetchTasks = async () => {
      try {
        const res = await axios.get(`https://cws-backend-roan.vercel.app/tasks/${managerId}`);
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const userRes = await axios.get("https://cws-backend-roan.vercel.app/me", {
        ...
        const res = await axios.get(
          `https://cws-backend-roan.vercel.app/api/projects/manager/${managerId}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        );
  ...
  async function fetchRequiredDetails() {
    try {
      ...
      const taskResponse = await axios.get("https://cws-backend-roan.vercel.app/task/getall");
