...
function AdminAddLeaveBalance({fetchNotifications}) {
  ...
  const fetchYearlySettings = async () => {
    try {
      const res = await axios.get(
        "https://cws-backend-roan.vercel.app/leave/yearly-settings",
      );
      setData(res.data);
    } catch (err) {
  ...
  const grantMonthly = async () => {
    try {
      const res = await axios.post(
        "https://cws-backend-roan.vercel.app/leave/grant-monthly",
        {
          sl,
          cl,
        },
  ...
  const fetchLeaveBalance = async () => {
    try {
      const res = await axios.get("https://cws-backend-roan.vercel.app/leave/balance");
  ...
  const HandleDelete = async (leaveId) => {
    ...
    try {
      await axios.delete(`https://cws-backend-roan.vercel.app/leave/${leaveId}`);
...
fetchNotifications();
  ...
  //   try {
  //     const res = await axios.post("https://cws-backend-roan.vercel.app/leave/reset-all");
  ...
  const resetYearlySettings = async () => {
    ...
    try {
      const res = await axios.delete("https://cws-backend-roan.vercel.app/leave/reset-all");
