    ...
    const fetchTeamLeaders = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://cws-backend-roan.vercel.app/employee/${user._id}/team-leader`,
          {
            headers: { 'Authorization': `Bearer ${token}` }
          }
        );
  ...
  useEffect(() => {
    const fetchManager = async () => {
      ...
      try {
        ...
        const res = await axios.get(`https://cws-backend-roan.vercel.app/users/${user.reportingManager}`);
