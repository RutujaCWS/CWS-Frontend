...
useEffect(() => {
  ...
  const fetchResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-backend-roan.vercel.app/resignation/manager/${managerId}`,
        {
          headers: {
  ...
  const handleDeleteResignation = async (resignationId) => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://cws-backend-roan.vercel.app/cancel/resignation/${resignationId}`,
        {
  ...
  const handleResignationAction = async (action) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://cws-backend-roan.vercel.app/resignation/${selected.originalData.resignationId}`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleApplyResignation = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://cws-backend-roan.vercel.app/resignation/apply",
        {
  ...
  const fetchMyResignations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://cws-backend-roan.vercel.app/resignation/${empId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
