...
//           axios.get(`https://cws-backend-roan.vercel.app/admin/weeklyoff/${new Date().getFullYear()}`),
//           axios.get(`https://cws-backend-roan.vercel.app/getHolidays`),
//           axios.get(`https://cws-backend-roan.vercel.app/attendance/regularization/my/${employeeId}`),
//         ]);
